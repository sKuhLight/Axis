...
Web frontend for **ForgeFX** — a control surface for Fractal devices (FM3 first). Axis is a
...
- `src/lib/forgefx.ts` — typed ForgeFX API client (`/blocks`, `/block/{name}/params`, `/param`, `/preset`, `/dump`, backup/restore)
...
- Modifiers (pedal → param) — later, via the live protocol
