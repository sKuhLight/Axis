...
<style>
  ...
  .incl { list-style: none; margin: 10px 0 0; padding: 12px; background: var(--bg2); border: 1px solid var(--border); border-radius: 10px; font-size: 12px; color: #b9b9c2; line-height: 1.7; }
